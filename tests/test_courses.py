...
def test_empty_courses_list(chromium_page_with_state: Page):
    ...
    courses_title_toolbar = chromium_page_with_state.get_by_test_id(
        "courses-list-toolbar-title-text"
    )
    expect(courses_title_toolbar).to_contain_text("Courses")

    courses_icon = chromium_page_with_state.get_by_test_id(
    ...
    courses_description = chromium_page_with_state.get_by_test_id(
