...
class TestCourses:
    ...
    def test_edit_course(self, create_course_page: CreateCoursePage, courses_list_page: CoursesListPage):
        ...
        courses_list_page.course_view.check_visible(index=1, title="Anime", max_score=10, min_score=1, estimated_time=77)
        courses_list_page.course_view_menu.click_edit(index=1)
