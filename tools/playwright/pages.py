...
def initialize_playwright_page(
    ...
    context = browser.new_context(base_url=settings.get_base_url(), storage_state=storage_state, record_video_dir=settings.videos_dir, viewport={"width": 1920, "height": 1080})
